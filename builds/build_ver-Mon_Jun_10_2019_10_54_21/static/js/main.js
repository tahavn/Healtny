...
(function ($) {
  ...
  submenuClass = '.pushy-submenu',
      ...
      submenu = $(submenuClass); //close menu w/ esc key
...
$(function () {
  var $body = document.body; // Аixing the menu when scrolling

  var $navigationWrap = document.querySelector('.main-header-wrap');
  var navigationHeight = $navigationWrap.offsetHeight;
  ...
  var $showBtn = document.querySelectorAll('.more-btn');
  var tempTextHeight = null;

  var _loop = function _loop(i) {
    var $textContainer = $showBtn[i].previousElementSibling;
    var $hideText = $textContainer.children[0];
    var textHeight = $hideText.offsetHeight;
    var $showText = $textContainer.children[1];
    var fullHeighText = $showText.scrollHeight;
    $showBtn[i].addEventListener('click', function (event) {
      event.preventDefault();

      if (!$showText.style.height) {
        tempTextHeight = textHeight;
        var showTextPromise = new Promise(function (resolve, reject) {
        ...
        var hideTextPromise = new Promise(function (resolve, reject) {
